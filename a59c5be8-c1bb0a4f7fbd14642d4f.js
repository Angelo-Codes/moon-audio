/*! For license information please see a59c5be8-c1bb0a4f7fbd14642d4f.js.LICENSE.txt */
            ...
            "undefined" != typeof self && self, t = function() {
                return function(A) {
                    ...
                    i.DEFAULT_SOURCE_GAIN = 1, i.LISTENER_MAX_OUTSIDE_ROOM_DISTANCE = 1, i.SOURCE_MAX_OUTSIDE_ROOM_DISTANCE = 1, i.DEFAULT_SOURCE_DISTANCE = 1, i.DEFAULT_POSITION = [0, 0, 0], i.DEFAULT_FORWARD = [0, 0, -1], i.DEFAULT_UP = [0, 1, 0], i.DEFAULT_RIGHT = [1, 0, 0], i.DEFAULT_SPEED_OF_SOUND = 343, i.ATTENUATION_ROLLOFFS = ["logarithmic", "linear", "none"], i.DEFAULT_ATTENUATION_ROLLOFF = "logarithmic", i.DEFAULT_MIN_DISTANCE = 1, i.DEFAULT_MAX_DISTANCE = 1e3, i.DEFAULT_DIRECTIVITY_ALPHA = 0, i.DEFAULT_DIRECTIVITY_SHARPNESS = 1, i.DEFAULT_AZIMUTH = 0, i.DEFAULT_ELEVATION = 0, i.DEFAULT_AMBISONIC_ORDER = 1, i.DEFAULT_SOURCE_WIDTH = 0, i.DEFAULT_REFLECTION_MAX_DURATION = .5, i.DEFAULT_REFLECTION_CUTOFF_FREQUENCY = 6400, i.DEFAULT_REFLECTION_COEFFICIENTS = {
                        ...
                        height: 0,
                        depth: 0
                    }, i.DEFAULT_REFLECTION_MULTIPLIER = 1, i.DEFAULT_REVERB_BANDWIDTH = 1, i.DEFAULT_REVERB_DURATION_MULTIPLIER = 1, i.DEFAULT_REVERB_PREDELAY = 1.5, i.DEFAULT_REVERB_TAIL_ONSET = 3.8, i.DEFAULT_REVERB_GAIN = .01, i.DEFAULT_REVERB_MAX_DURATION = 3, i.DEFAULT_REVERB_FREQUENCY_BANDS = [31.25, 62.5, 125, 250, 500, 1e3, 2e3, 4e3, 8e3], i.NUMBER_REVERB_FREQUENCY_BANDS = i.DEFAULT_REVERB_FREQUENCY_BANDS.length, i.DEFAULT_REVERB_DURATIONS = new Float32Array(i.NUMBER_REVERB_FREQUENCY_BANDS), i.ROOM_MATERIAL_COEFFICIENTS = {
                        ...
                        return t > i.EPSILON_FLOAT && (t = 1 / t, A[0] *= t, A[1] *= t, A[2] *= t), A
                    ...
                    function s(A, t) {
                        null == t && (t = {}), null == t.ambisonicOrder && (t.ambisonicOrder = n.a.DEFAULT_AMBISONIC_ORDER), null == t.azimuth && (t.azimuth = n.a.DEFAULT_AZIMUTH), null == t.elevation && (t.elevation = n.a.DEFAULT_ELEVATION), null == t.sourceWidth && (t.sourceWidth = n.a.DEFAULT_SOURCE_WIDTH), this._context = A, this.input = A.createGain(), this._channelGain = [], this._merger = void 0, this.output = A.createGain(), this.setAmbisonicOrder(t.ambisonicOrder), this._azimuth = t.azimuth, this._elevation = t.elevation, this.setSourceWidth(t.sourceWidth)
                    }
                    s.prototype.setAmbisonicOrder = function(A) {
                        this._ambisonicOrder = s.validateAmbisonicOrder(A), this.input.disconnect();
                        for (var t = 0; t < this._channelGain.length; t++) this._channelGain[t].disconnect();
                        null != this._merger && this._merger.disconnect(), delete this._channelGain, delete this._merger;
                        var e = (this._ambisonicOrder + 1) * (this._ambisonicOrder + 1);
                        this._merger = this._context.createChannelMerger(e), this._channelGain = new Array(e);
                        for (var i = 0; i < e; i++) this._channelGain[i] = this._context.createGain(), this.input.connect(this._channelGain[i]), this._channelGain[i].connect(this._merger, 0, i);
                        this._merger.connect(this.output)
                    }, s.prototype.setDirection = function(A, t) {
                        (null == A || isNaN(A)) && (A = n.a.DEFAULT_AZIMUTH), (null == t || isNaN(t)) && (t = n.a.DEFAULT_ELEVATION), this._azimuth = A, this._elevation = t, (A = Math.round(A % 360)) < 0 && (A += 360), t = Math.round(Math.min(90, Math.max(-90, t))) + 90, this._channelGain[0].gain.value = i.a.MAX_RE_WEIGHTS[this._spreadIndex][0];
                        for (var e = 1; e <= this._ambisonicOrder; e++)
                            for (var s = i.a.MAX_RE_WEIGHTS[this._spreadIndex][e], a = -e; a <= e; a++) {
                                var r = e * e + e + a,
                                    o = e * (e + 1) / 2 + Math.abs(a) - 1,
                                    h = i.a.SPHERICAL_HARMONICS[1][t][o];
                                if (0 != a) {
                                    var c = i.a.SPHERICAL_HARMONICS_MAX_ORDER + a - 1;
                                    a < 0 && (c = i.a.SPHERICAL_HARMONICS_MAX_ORDER + a), h *= i.a.SPHERICAL_HARMONICS[0][A][c]
                                }
                                this._channelGain[r].gain.value = h * s
                            }
                        ...
                        return isNaN(A) || null == A ? (n.a.log("Error: Invalid ambisonic order", options.ambisonicOrder, "\nUsing ambisonicOrder=1 instead."), A = 1) : A < 1 ? (n.a.log("Error: Unable to render ambisonic order", options.ambisonicOrder, "(Min order is 1)", "\nUsing min order instead."), A = 1) : A > i.a.SPHERICAL_HARMONICS_MAX_ORDER && (n.a.log("Error: Unable to render ambisonic order", options.ambisonicOrder, "(Max order is", i.a.SPHERICAL_HARMONICS_MAX_ORDER, ")\nUsing max order instead."), options.ambisonicOrder = i.a.SPHERICAL_HARMONICS_MAX_ORDER), A
                    }, t.a = s
                }, function(A, t, e) {
                    "use strict";
                    var i = e(12),
                    ...
                    function a(A, t) {
                        null == t && (t = {}), null == t.ambisonicOrder && (t.ambisonicOrder = s.a.DEFAULT_AMBISONIC_ORDER), null == t.position && (t.position = s.a.DEFAULT_POSITION.slice()), null == t.forward && (t.forward = s.a.DEFAULT_FORWARD.slice()), null == t.up && (t.up = s.a.DEFAULT_UP.slice()), this.position = new Float32Array(3), this._tempMatrix3 = new Float32Array(9), this._ambisonicOrder = n.a.validateAmbisonicOrder(t.ambisonicOrder), this._context = A, 1 == this._ambisonicOrder ? this._renderer = i.a.createFOARenderer(A, {}) : this._ambisonicOrder > 1 && (this._renderer = i.a.createHOARenderer(A, {
                    ...
                    a.prototype.setOrientation = function(A, t, e, i, n, a) {
                        var r = s.a.crossProduct([A, t, e], [i, n, a]);
                        this._tempMatrix3[0] = r[0], this._tempMatrix3[1] = r[1], this._tempMatrix3[2] = r[2], this._tempMatrix3[3] = i, this._tempMatrix3[4] = n, this._tempMatrix3[5] = a, this._tempMatrix3[6] = A, this._tempMatrix3[7] = t, this._tempMatrix3[8] = e, this._renderer.setRotationMatrix3(this._tempMatrix3)
                    ...
                    var i = [
                            ...
                            [
                                [-1, -0, 1, -0, 0, -1, -0, 0, -0],
                                [-.999848, .017452, .999543, -.030224, 264e-6, -.999086, .042733, -59e-5, 4e-6],
                                [-.999391, .034899, .998173, -.060411, .001055, -.996348, .085356, -.002357, 34e-6],
                                [-.99863, .052336, .995891, -.090524, .002372, -.991791, .127757, -.005297, 113e-6],
                                [-.997564, .069756, .992701, -.120527, .004214, -.985429, .169828, -.0094, 268e-6],
                                [-.996195, .087156, .988606, -.150384, .006578, -.977277, .21146, -.014654, 523e-6],
                                [-.994522, .104528, .983611, -.180057, .009462, -.967356, .252544, -.021043, 903e-6],
                        ...
                        o = r.length;
                    t.a = {
                        SPHERICAL_HARMONICS: i,
                        SPHERICAL_HARMONICS_AZIMUTH_RESOLUTION: n,
                        SPHERICAL_HARMONICS_ELEVATION_RESOLUTION: s,
                        SPHERICAL_HARMONICS_MAX_ORDER: a,
                        MAX_RE_WEIGHTS: r,
                        MAX_RE_WEIGHTS_RESOLUTION: o
                    }
                }, function(A, t, e) {
                    "use strict";
                    var i = e(5),
                    ...
                    function r(A, t) {
                        null == t && (t = {}), null == t.position && (t.position = a.a.DEFAULT_POSITION.slice()), null == t.forward && (t.forward = a.a.DEFAULT_FORWARD.slice()), null == t.up && (t.up = a.a.DEFAULT_UP.slice()), null == t.minDistance && (t.minDistance = a.a.DEFAULT_MIN_DISTANCE), null == t.maxDistance && (t.maxDistance = a.a.DEFAULT_MAX_DISTANCE), null == t.rolloff && (t.rolloff = a.a.DEFAULT_ROLLOFF), null == t.gain && (t.gain = a.a.DEFAULT_SOURCE_GAIN), null == t.alpha && (t.alpha = a.a.DEFAULT_DIRECTIVITY_ALPHA), null == t.sharpness && (t.sharpness = a.a.DEFAULT_DIRECTIVITY_SHARPNESS), null == t.sourceWidth && (t.sourceWidth = a.a.DEFAULT_SOURCE_WIDTH), this._scene = A, this._position = t.position, this._forward = t.forward, this._up = t.up, this._dx = new Float32Array(3), this._right = a.a.crossProduct(this._forward, this._up);
                        var e = A._context;
                        this.input = e.createGain(), this._directivity = new i.a(e, {
                            alpha: t.alpha,
                            sharpness: t.sharpness
                        }), this._toEarly = e.createGain(), this._toLate = e.createGain(), this._attenuation = new n.a(e, {
                            minDistance: t.minDistance,
                            maxDistance: t.maxDistance,
                            rolloff: t.rolloff
                        }), this._encoder = new s.a(e, {
                    ...
                    r.prototype.setPosition = function(A, t, e) {
                        ...
                        var i = function(A) {
                            var t = 1;
                            return A > a.a.EPSILON_FLOAT && (t = 1 - A / a.a.SOURCE_MAX_OUTSIDE_ROOM_DISTANCE, t = Math.max(0, Math.min(1, t))), t
                        }(this._scene._room.getDistanceOutsideRoom(this._position[0], this._position[1], this._position[2]));
                        this._toLate.gain.value = i, this._toEarly.gain.value = i, this._update()
                    }, r.prototype._update = function() {
                        for (var A = 0; A < 3; A++) this._dx[A] = this._position[A] - this._scene._listener.position[A];
                        var t = Math.sqrt(this._dx[0] * this._dx[0] + this._dx[1] * this._dx[1] + this._dx[2] * this._dx[2]);
                        t > 0 && (this._dx[0] /= t, this._dx[1] /= t, this._dx[2] /= t);
                        var e = Math.atan2(-this._dx[0], this._dx[2]) * a.a.RADIANS_TO_DEGREES,
                            i = Math.atan2(this._dx[1], Math.sqrt(this._dx[0] * this._dx[0] + this._dx[2] * this._dx[2])) * a.a.RADIANS_TO_DEGREES;
                        this._attenuation.setDistance(t), this._directivity.computeAngle(this._forward, this._dx), this._encoder.setDirection(e, i)
                        ...
                        this._forward[0] = A, this._forward[1] = t, this._forward[2] = e, this._up[0] = i, this._up[1] = n, this._up[2] = s, this._right = a.a.crossProduct(this._forward, this._up)
                    }, r.prototype.setFromMatrix = function(A) {
                        this._right[0] = A.elements[0], this._right[1] = A.elements[1], this._right[2] = A.elements[2], this._up[0] = A.elements[4], this._up[1] = A.elements[5], this._up[2] = A.elements[6], this._forward[0] = A.elements[8], this._forward[1] = A.elements[9], this._forward[2] = A.elements[10], this._right = a.a.normalizeVector(this._right), this._up = a.a.normalizeVector(this._up), this._forward = a.a.normalizeVector(this._forward), this.setPosition(A.elements[12], A.elements[13], A.elements[14])
                    ...
                    function n(A, t) {
                        null == t && (t = {}), null == t.alpha && (t.alpha = i.a.DEFAULT_DIRECTIVITY_ALPHA), null == t.sharpness && (t.sharpness = i.a.DEFAULT_DIRECTIVITY_SHARPNESS), this._context = A, this._lowpass = A.createBiquadFilter(), this._lowpass.type = "lowpass", this._lowpass.Q.value = 0, this._lowpass.frequency.value = .5 * A.sampleRate, this._cosTheta = 0, this.setPattern(t.alpha, t.sharpness), this.input = this._lowpass, this.output = this._lowpass
                    }
                    n.prototype.computeAngle = function(A, t) {
                        var e = i.a.normalizeVector(A),
                            n = i.a.normalizeVector(t),
                            s = 1;
                        if (this._alpha > i.a.EPSILON_FLOAT) {
                            var a = e[0] * n[0] + e[1] * n[1] + e[2] * n[2];
                    ...
                    n.prototype.setDistance = function(A) {
                        ...
                        if ("logarithmic" == this._rolloff) {
                            if (A > this.maxDistance) t = 0;
                                ...
                                var e = this.maxDistance - this.minDistance;
                                if (e > i.a.EPSILON_FLOAT) {
                                    var n = 1 / (e + 1);
                                    t = (1 / (A - this.minDistance + 1) - n) / (1 - n)
                                }
                            }
                        } else if ("linear" == this._rolloff)
                            if (A > this.maxDistance) t = 0;
                            else if (A > this.minDistance) {
                            var s = this.maxDistance - this.minDistance;
                            s > i.a.EPSILON_FLOAT && (t = (this.maxDistance - A) / s)
                        }
                        this._gainNode.gain.value = t
                    }, n.prototype.setRolloff = function(A) {
                        var t = ~i.a.ATTENUATION_ROLLOFFS.indexOf(A);
                        null != A && t ? A = A.toString().toLowerCase() : (t || i.a.log('Invalid rolloff model ("' + A + '"). Using default: "' + i.a.DEFAULT_ATTENUATION_ROLLOFF + '".'), A = i.a.DEFAULT_ATTENUATION_ROLLOFF), this._rolloff = A
                    }, t.a = n
                }, function(A, t, e) {
                    "use strict";
                    var i = e(8),
                    ...
                    function a(A) {
                        var t = {};
                        for (var e in s.a.DEFAULT_ROOM_MATERIALS) s.a.DEFAULT_ROOM_MATERIALS.hasOwnProperty(e) && (t[e] = s.a.ROOM_MATERIAL_COEFFICIENTS[s.a.DEFAULT_ROOM_MATERIALS[e]]);
                        for (var i in null == A && (A = {}, Object.assign(A, s.a.DEFAULT_ROOM_MATERIALS)), s.a.DEFAULT_ROOM_MATERIALS) s.a.DEFAULT_ROOM_MATERIALS.hasOwnProperty(i) && A.hasOwnProperty(i) ? A[i] in s.a.ROOM_MATERIAL_COEFFICIENTS ? t[i] = s.a.ROOM_MATERIAL_COEFFICIENTS[A[i]] : s.a.log('Material "' + A[i] + '" on wall "' + i + '" not found. Using "' + s.a.DEFAULT_ROOM_MATERIALS[i] + '".') : s.a.log('Wall "' + i + '" is not defined. Default used.');
                        return t
                    }

                    function r(A) {
                        for (var t in null == A && (A = {}), s.a.DEFAULT_ROOM_DIMENSIONS) A.hasOwnProperty(t) || (A[t] = s.a.DEFAULT_ROOM_DIMENSIONS[t]);
                        return A
                    }

                    function o(A, t, e) {
                        var i = new Float32Array(s.a.NUMBER_REVERB_FREQUENCY_BANDS);
                        A = r(A), t = function(A) {
                            for (var t in null == A && (A = {}), s.a.DEFAULT_ROOM_MATERIALS) A.hasOwnProperty(t) || (A[t] = s.a.ROOM_MATERIAL_COEFFICIENTS[s.a.DEFAULT_ROOM_MATERIALS[t]]);
                            return A
                        }(t), null == e && (e = s.a.DEFAULT_SPEED_OF_SOUND);
                        var n = s.a.TWENTY_FOUR_LOG10 / e,
                            a = A.width * A.height * A.depth;
                        if (a < s.a.ROOM_MIN_VOLUME) return i;
                        for (var o = A.width * A.height, h = A.width * A.depth, c = A.depth * A.height, _ = 2 * (o + h + c), D = 0; D < s.a.NUMBER_REVERB_FREQUENCY_BANDS; D++) {
                            var f = ((t.left[D] + t.right[D]) * o + (t.down[D] + t.up[D]) * h + (t.front[D] + t.back[D]) * c) / _;
                            i[D] = s.a.ROOM_EYRING_CORRECTION_COEFFICIENT * n * a / (-_ * Math.log(1 - f) + 4 * s.a.ROOM_AIR_ABSORPTION_COEFFICIENTS[D] * a)
                        }
                        return i
                    }
                    ...
                    function h(A) {
                        var t = [];
                        for (var e in s.a.DEFAULT_REFLECTION_COEFFICIENTS)
                            if (s.a.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(e)) {
                                t[e] = 0;
                                for (var i = 0; i < s.a.NUMBER_REFLECTION_AVERAGING_BANDS; i++) {
                                    var n = i + s.a.ROOM_STARTING_AVERAGING_BAND;
                                    t[e] += A[e][n]
                                }
                                t[e] /= s.a.NUMBER_REFLECTION_AVERAGING_BANDS, t[e] = Math.sqrt(1 - t[e])
                            }
                        return t
                    }

                    function c(A, t) {
                        null == t && (t = {}), null == t.listenerPosition && (t.listenerPosition = s.a.DEFAULT_POSITION.slice()), null == t.dimensions && (t.dimensions = {}, Object.assign(t.dimensions, s.a.DEFAULT_ROOM_DIMENSIONS)), null == t.materials && (t.materials = {}, Object.assign(t.materials, s.a.DEFAULT_ROOM_MATERIALS)), null == t.speedOfSound && (t.speedOfSound = s.a.DEFAULT_SPEED_OF_SOUND), t.dimensions = r(t.dimensions);
                        var e = a(t.materials),
                            c = h(e),
                            _ = o(t.dimensions, e, t.speedOfSound);
                        this.early = new n.a(A, {
                    ...
                    c.prototype.setProperties = function(A, t) {
                        ...
                        var i = this.getDistanceOutsideRoom(A, t, e),
                            n = 1;
                        i > s.a.EPSILON_FLOAT && (n = 1 - i / s.a.LISTENER_MAX_OUTSIDE_ROOM_DISTANCE, n = Math.max(0, Math.min(1, n))), this.output.gain.value = n
                    ...
                    function n(A, t) {
                        null == t && (t = {}), null == t.durations && (t.durations = i.a.DEFAULT_REVERB_DURATIONS.slice()), null == t.predelay && (t.predelay = i.a.DEFAULT_REVERB_PREDELAY), null == t.gain && (t.gain = i.a.DEFAULT_REVERB_GAIN), null == t.bandwidth && (t.bandwidth = i.a.DEFAULT_REVERB_BANDWIDTH), null == t.tailonset && (t.tailonset = i.a.DEFAULT_REVERB_TAIL_ONSET);
                        var e = t.predelay / 1e3;
                        this._bandwidthCoeff = t.bandwidth * i.a.LOG2_DIV2, this._tailonsetSamples = t.tailonset / 1e3, this._context = A, this.input = A.createGain(), this._predelay = A.createDelay(e), this._convolver = A.createConvolver(), this.output = A.createGain(), this.output.gain.value = t.gain, this._convolver.normalize = !1, this.input.connect(this._predelay), this._predelay.connect(this._convolver), this._convolver.connect(this.output), this.setDurations(t.durations)
                    }
                    n.prototype.setDurations = function(A) {
                        if (A.length === i.a.NUMBER_REVERB_FREQUENCY_BANDS) {
                            for (var t = new Float32Array(i.a.NUMBER_REVERB_FREQUENCY_BANDS), e = this._context.sampleRate, n = 0; n < A.length; n++) A[n] = Math.max(0, Math.min(i.a.DEFAULT_REVERB_MAX_DURATION, A[n])), t[n] = Math.round(A[n] * e * i.a.DEFAULT_REVERB_DURATION_MULTIPLIER);
                            for (var s = 0, a = 0; a < t.length; a++) t[a] > s && (s = t[a]);
                            s < 1 && (s = 1);
                            for (var r = this._context.createBuffer(1, s, e), o = r.getChannelData(0), h = new Float32Array(s), c = 0; c < s; c++) h[c] = 2 * Math.random() - 1;
                            for (var _ = 0; _ < i.a.NUMBER_REVERB_FREQUENCY_BANDS; _++)
                                for (var D = -i.a.LOG1000 / t[_], f = i.a.TWO_PI * i.a.DEFAULT_REVERB_FREQUENCY_BANDS[_] / e, l = Math.sin(f), u = l * Math.sinh(this._bandwidthCoeff * f / l), g = 1 / (1 + u), v = u * g, w = -2 * Math.cos(f) * g, E = (1 - u) * g, P = 0, d = 0, p = 0; p < t[_]; p++) {
                                    var B = h[p] * Math.exp(D * p) - w * P - E * d;
                                    o[p] += v * (B - d), d = P, P = B
                                }
                            for (var C = Math.round(this._tailonsetSamples), I = 0; I < Math.min(o.length, C); I++) {
                                var O = .5 * (1 - Math.cos(i.a.TWO_PI * I / (2 * C - 1)));
                                o[I] *= O
                            }
                            this._convolver.buffer = r
                        } else i.a.log("Warning: invalid number of RT60 values provided to reverb.")
                    }, t.a = n
                }, function(A, t, e) {
                    "use strict";
                    var i = e(0);
                    ...
                    function n(A, t) {
                        for (var e in null == t && (t = {}), null == t.speedOfSound && (t.speedOfSound = i.a.DEFAULT_SPEED_OF_SOUND), null == t.listenerPosition && (t.listenerPosition = i.a.DEFAULT_POSITION.slice()), null == t.coefficients && (t.coefficients = {}, Object.assign(t.coefficients, i.a.DEFAULT_REFLECTION_COEFFICIENTS)), this.speedOfSound = t.speedOfSound, this.input = A.createGain(), this.output = A.createGain(), this._lowpass = A.createBiquadFilter(), this._delays = {}, this._gains = {}, this._inverters = {}, this._merger = A.createChannelMerger(4), i.a.DEFAULT_REFLECTION_COEFFICIENTS) i.a.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(e) && (this._delays[e] = A.createDelay(i.a.MAX_DURATION), this._gains[e] = A.createGain());
                        for (var n in this._inverters.right = A.createGain(), this._inverters.down = A.createGain(), this._inverters.back = A.createGain(), this._lowpass.type = "lowpass", this._lowpass.frequency.value = i.a.DEFAULT_REFLECTION_CUTOFF_FREQUENCY, this._lowpass.Q.value = 0, i.a.DEFAULT_REFLECTION_COEFFICIENTS) i.a.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(n) && (this._delays[n].delayTime.value = 0, this._gains[n].gain.value = 0);
                        for (var s in this._inverters.right.gain.value = -1, this._inverters.down.gain.value = -1, this._inverters.back.gain.value = -1, this.input.connect(this._lowpass), i.a.DEFAULT_REFLECTION_COEFFICIENTS) i.a.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(s) && (this._lowpass.connect(this._delays[s]), this._delays[s].connect(this._gains[s]), this._gains[s].connect(this._merger, 0, 0));
                    ...
                    n.prototype.setListenerPosition = function(A, t, e) {
                        ...
                        var n = {
                            left: i.a.DEFAULT_REFLECTION_MULTIPLIER * Math.max(0, this._halfDimensions.width + A) + i.a.DEFAULT_REFLECTION_MIN_DISTANCE,
                            right: i.a.DEFAULT_REFLECTION_MULTIPLIER * Math.max(0, this._halfDimensions.width - A) + i.a.DEFAULT_REFLECTION_MIN_DISTANCE,
                            front: i.a.DEFAULT_REFLECTION_MULTIPLIER * Math.max(0, this._halfDimensions.depth + e) + i.a.DEFAULT_REFLECTION_MIN_DISTANCE,
                            back: i.a.DEFAULT_REFLECTION_MULTIPLIER * Math.max(0, this._halfDimensions.depth - e) + i.a.DEFAULT_REFLECTION_MIN_DISTANCE,
                            down: i.a.DEFAULT_REFLECTION_MULTIPLIER * Math.max(0, this._halfDimensions.height + t) + i.a.DEFAULT_REFLECTION_MIN_DISTANCE,
                            up: i.a.DEFAULT_REFLECTION_MULTIPLIER * Math.max(0, this._halfDimensions.height - t) + i.a.DEFAULT_REFLECTION_MIN_DISTANCE
                        };
                        for (var s in i.a.DEFAULT_REFLECTION_COEFFICIENTS)
                            if (i.a.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(s)) {
                                var a = n[s] / this.speedOfSound;
                                this._delays[s].delayTime.value = a;
                                var r = this._coefficients[s] / n[s];
                                this._gains[s].gain.value = r
                            }
                    }, n.prototype.setRoomProperties = function(A, t) {
                        null == A && (A = {}, Object.assign(A, i.a.DEFAULT_ROOM_DIMENSIONS)), null == t && (t = {}, Object.assign(t, i.a.DEFAULT_REFLECTION_COEFFICIENTS)), this._coefficients = t, this._halfDimensions = {}, this._halfDimensions.width = .5 * A.width, this._halfDimensions.height = .5 * A.height, this._halfDimensions.depth = .5 * A.depth, this.setListenerPosition(this._listenerPosition[0], this._listenerPosition[1], this._listenerPosition[2])
                    }, t.a = n
                }, function(A, t, e) {
                    "use strict";
                    ...
                    var i = e(11),
                        ...
                        f = e(0),
                        l = e(13);
                    "undefined" != typeof window && (window.ResonanceAudio = i.a), i.a.Attenuation = n.a, i.a.Directivity = s.a, i.a.EarlyReflections = a.a, i.a.Encoder = r.a, i.a.LateReflections = o.a, i.a.Listener = h.a, i.a.Room = c.a, i.a.Source = _.a, i.a.Tables = D.a, i.a.Utils = f.a, i.a.Version = l.a, t.default = i.a
                }, function(A, t, e) {
                    "use strict";
                    var i = e(2),
                        n = e(4),
                    ...
                    function o(A, t) {
                        null == t && (t = {}), null == t.ambisonicOrder && (t.ambisonicOrder = r.a.DEFAULT_AMBISONIC_ORDER), null == t.listenerPosition && (t.listenerPosition = r.a.DEFAULT_POSITION.slice()), null == t.listenerForward && (t.listenerForward = r.a.DEFAULT_FORWARD.slice()), null == t.listenerUp && (t.listenerUp = r.a.DEFAULT_UP.slice()), null == t.dimensions && (t.dimensions = {}, Object.assign(t.dimensions, r.a.DEFAULT_ROOM_DIMENSIONS)), null == t.materials && (t.materials = {}, Object.assign(t.materials, r.a.DEFAULT_ROOM_MATERIALS)), null == t.speedOfSound && (t.speedOfSound = r.a.DEFAULT_SPEED_OF_SOUND), this._ambisonicOrder = a.a.validateAmbisonicOrder(t.ambisonicOrder), this._sources = [], this._room = new s.a(A, {
                            listenerPosition: t.listenerPosition,
                            dimensions: t.dimensions,
                            materials: t.materials,
                            speedOfSound: t.speedOfSound
                        }), this._listener = new i.a(A, {
                    ...
                    o.prototype.createSource = function(A) {
                        var t = new n.a(this, A);
                        return this._sources[this._sources.length] = t, t
                    }, o.prototype.setAmbisonicOrder = function(A) {
                        this._ambisonicOrder = a.a.validateAmbisonicOrder(A)
                    }, o.prototype.setRoomProperties = function(A, t) {
                        this._room.setProperties(A, t)
                    }, o.prototype.setListenerPosition = function(A, t, e) {
                    ...
                    }, o.prototype.setListenerOrientation = function(A, t, e, i, n, s) {
                        this._listener.setOrientation(A, t, e, i, n, s)
                    }, o.prototype.setListenerFromMatrix = function(A) {
                    ...
                    }, o.prototype.setSpeedOfSound = function(A) {
                        this._room.speedOfSound = A
                    }, t.a = o
                }, function(A, t, e) {
                    "use strict";
                    var i, n, s, a, r, o, h, c, _, D, f, l, u, g, v, w, E, P, d, p, B, C, I, O, M, m, Q, R, F, T = {
                            log: function() {
                                var A = "undefined" != typeof window;
                                A && (Array.prototype.slice.call(arguments).join(" "), performance.now().toFixed(2))
                            },
                            throw: function() {
                                var A = "[Omnitone] " + Array.prototype.slice.call(arguments).join(" ") + " (" + performance.now().toFixed(2) + "ms)";
                                throw new Error(A)
                            },
                            invertMatrix4: function(A, t) {
                                return i = t[0], n = t[1], s = t[2], a = t[3], r = t[4], o = t[5], h = t[6], c = t[7], _ = t[8], D = t[9], f = t[10], l = t[11], u = t[12], g = t[13], v = t[14], w = t[15], (F = (E = i * o - n * r) * (R = f * w - l * v) - (P = i * h - s * r) * (Q = D * w - l * g) + (d = i * c - a * r) * (m = D * v - f * g) + (p = n * h - s * o) * (M = _ * w - l * u) - (B = n * c - a * o) * (O = _ * v - f * u) + (C = s * c - a * h) * (I = _ * g - D * u)) ? (F = 1 / F, A[0] = (o * R - h * Q + c * m) * F, A[1] = (s * Q - n * R - a * m) * F, A[2] = (g * C - v * B + w * p) * F, A[3] = (f * B - D * C - l * p) * F, A[4] = (h * M - r * R - c * O) * F, A[5] = (i * R - s * M + a * O) * F, A[6] = (v * d - u * C - w * P) * F, A[7] = (_ * C - f * d + l * P) * F, A[8] = (r * Q - o * M + c * I) * F, A[9] = (n * M - i * Q - a * I) * F, A[10] = (u * B - g * d + w * E) * F, A[11] = (D * d - _ * B - l * E) * F, A[12] = (o * O - r * m - h * I) * F, A[13] = (i * m - n * O + s * I) * F, A[14] = (g * P - u * p - v * E) * F, A[15] = (_ * p - D * P + f * E) * F, A) : null
                            },
                            isDefinedENUMEntry: function(A, t) {
                                for (var e in A)
                                    if (t === A[e]) return !0;
                                return !1
                            },
                            isAudioContext: function(A) {
                                return A instanceof AudioContext || A instanceof OfflineAudioContext
                            },
                            isAudioBuffer: function(A) {
                                return A instanceof AudioBuffer
                            },
                            mergeBufferListByChannel: function(A, t) {
                                for (var e = t[0].length, i = t[0].sampleRate, n = 0, s = 0; s < t.length; ++s) n > 32 && T.throw("Utils.mergeBuffer: Number of channels cannot exceed 32.(got " + n + ")"), e !== t[s].length && T.throw("Utils.mergeBuffer: AudioBuffer lengths are inconsistent. (expected " + e + " but got " + t[s].length + ")"), i !== t[s].sampleRate && T.throw("Utils.mergeBuffer: AudioBuffer sample rates are inconsistent. (expected " + i + " but got " + t[s].sampleRate + ")"), n += t[s].numberOfChannels;
                                for (var a = A.createBuffer(n, e, i), r = 0, o = 0; o < t.length; ++o)
                                    for (var h = 0; h < t[o].numberOfChannels; ++h) a.getChannelData(r++).set(t[o].getChannelData(h));
                                return a
                            },
                            splitBufferbyChannel: function(A, t, e) {
                                t.numberOfChannels <= e && T.throw("Utils.splitBuffer: Insufficient number of channels. (" + t.numberOfChannels + " splitted by " + e + ")");
                                for (var i = 0, n = Math.ceil(t.numberOfChannels / e), s = 0; s < n; ++s)
                                    for (var a = A.createBuffer(e, t.length, t.sampleRate), r = 0; r < e; ++r) i < t.numberOfChannels && a.getChannelData(r).set(t.getChannelData(i++));
                                return bufferList
                            },
                            getArrayBufferFromBase64String: function(A) {
                                var t = window.atob(A),
                    ...
                    function x(A, t, e) {
                        this._context = T.isAudioContext(A) ? A : T.throw("BufferList: Invalid BaseAudioContext."), this._options = {
                            dataType: L.BASE64,
                            verbose: !1
                        }, e && (e.dataType && T.isDefinedENUMEntry(L, e.dataType) && (this._options.dataType = e.dataType), e.verbose && (this._options.verbose = Boolean(e.verbose))), this._bufferList = [], this._bufferData = this._options.dataType === L.BASE64 ? t : t.slice(0), this._numberOfTasks = this._bufferData.length, this._resolveHandler = null, this._rejectHandler = null
                    }
                    x.prototype.load = function() {
                        return new Promise(this._promiseGenerator.bind(this))
                    }, x.prototype._promiseGenerator = function(A, t) {
                        "function" != typeof A ? T.throw("BufferList: Invalid Promise resolver.") : this._resolveHandler = A, "function" == typeof t && (this._rejectHandler = t);
                        for (var e = 0; e < this._bufferData.length; ++e) this._options.dataType === L.BASE64 ? this._launchAsyncLoadTask(e) : this._launchAsyncLoadTaskXHR(e)
                    }, x.prototype._launchAsyncLoadTask = function(A) {
                        var t = this;
                        this._context.decodeAudioData(T.getArrayBufferFromBase64String(this._bufferData[A]), (function(e) {
                            t._updateProgress(A, e)
                        }), (function(e) {
                            t._updateProgress(A, null);
                            var i = 'BufferList: decoding ArrayByffer("' + A + '" from Base64-encoded data failed. (' + e + ")";
                            t._rejectHandler(i), T.throw(i)
                        }))
                    }, x.prototype._launchAsyncLoadTaskXHR = function(A) {
                        ...
                        t.onload = function() {
                            if (200 === t.status) e._context.decodeAudioData(t.response, (function(t) {
                                ...
                                e._rejectHandler(i), T.log(i)
                            }));
                            else {
                                var i = 'BufferList: XHR error while loading "' + e._bufferData[A] + '". (' + t.status + " " + t.statusText + ")";
                                e._rejectHandler(i), T.log(i)
                            }
                        }, t.onerror = function(t) {
                            e._updateProgress(A, null), e._rejectHandler(), T.log('BufferList: XHR network failed on loading "' + e._bufferData[A] + '".')
                        }, t.send()
                    }, x.prototype._updateProgress = function(A, t) {
                        if (this._bufferList[A] = t, this._options.verbose) {
                            var e = this._options.dataType === L.BASE64 ? "ArrayBuffer(" + A + ") from Base64-encoded HRIR" : '"' + this._bufferData[A] + '"';
                            T.log("BufferList: " + e + " successfully loaded.")
                        }
                        if (0 == --this._numberOfTasks) {
                            var i = this._options.dataType === L.BASE64 ? this._bufferData.length + " AudioBuffers from Base64-encoded HRIRs" : this._bufferData.length + " files via XHR";
                            T.log("BufferList: " + i + " loaded successfully."), this._resolveHandler(this._bufferList)
                        }
                    };
                    var U = {
                        DEFAULT: [0, 1, 2, 3],
                    ...
                    function N(A, t) {
                        this._context = A, this._splitter = this._context.createChannelSplitter(4), this._merger = this._context.createChannelMerger(4), this.input = this._splitter, this.output = this._merger, this.setChannelMap(t || U.DEFAULT)
                    }
                    ...
                    }, N.ChannelMap = U, b.prototype.setRotationMatrix3 = function(A) {
                    ...
                    }, b.prototype.setRotationMatrix4 = function(A) {
                    ...
                    }, b.prototype.getRotationMatrix3 = function() {
                    ...
                    }, b.prototype.getRotationMatrix4 = function() {
                    ...
                    }, y.prototype.setHRIRBufferList = function(A) {
                    ...
                    function G(A, t) {
                        this._context = T.isAudioContext(A) ? A : T.throw("FOARenderer: Invalid BaseAudioContext."), this._config = {
                            channelMap: N.ChannelMap.DEFAULT,
                            renderingMode: H.AMBISONIC
                        }, t && (t.channelMap && (Array.isArray(t.channelMap) && 4 === t.channelMap.length ? this._config.channelMap = t.channelMap : T.throw("FOARenderer: Invalid channel map. (got " + t.channelMap + ")")), t.hrirPathList && (Array.isArray(t.hrirPathList) && 2 === t.hrirPathList.length ? this._config.pathList = t.hrirPathList : T.throw("FOARenderer: Invalid HRIR URLs. It must be an array with 2 URLs to HRIR files. (got " + t.hrirPathList + ")")), t.renderingMode && (Object.values(H).includes(t.renderingMode) ? this._config.renderingMode = t.renderingMode : T.log("FOARenderer: Invalid rendering mode order. (got" + t.renderingMode + ') Fallbacks to the mode "ambisonic".'))), this._buildAudioGraph(), this._tempMatrix4 = new Float32Array(16), this._isRendererReady = !1
                    }
                    ...
                    function j(A, t, e, i, n) {
                        return i === n ? k(A, 1, t, 1) * k(A, n - 1, e, n - 1) - k(A, 1, t, -1) * k(A, n - 1, e, 1 - n) : i === -n ? k(A, 1, t, 1) * k(A, n - 1, e, 1 - n) + k(A, 1, t, -1) * k(A, n - 1, e, n - 1) : k(A, 1, t, 0) * k(A, n - 1, e, i)
                    }
                    ...
                    function V(A, t, e, i) {
                        if (0 === t) return j(A, 1, 1, e, i) + j(A, -1, -1, e, i);
                        if (t > 0) {
                            var n = Y(t, 1);
                            return j(A, 1, t - 1, e, i) * Math.sqrt(1 + n) - j(A, -1, 1 - t, e, i) * (1 - n)
                        }
                        var s = Y(t, -1);
                        return j(A, 1, t + 1, e, i) * (1 - s) + j(A, -1, -t - 1, e, i) * Math.sqrt(1 + s)
                    }

                    function W(A, t, e, i) {
                        return 0 === t ? 0 : t > 0 ? j(A, 1, t + 1, e, i) + j(A, -1, -t - 1, e, i) : j(A, 1, t - 1, e, i) - j(A, -1, 1 - t, e, i)
                    }
                    ...
                    function K(A, t) {
                        for (var e = -t; e <= t; e++)
                            for (var i = -t; i <= t; i++) {
                                var n = J(e, i, t);
                                Math.abs(n[0]) > 0 && (n[0] *= Z(A, e, i, t)), Math.abs(n[1]) > 0 && (n[1] *= V(A, e, i, t)), Math.abs(n[2]) > 0 && (n[2] *= W(A, e, i, t)), X(A, t, e, i, n[0] + n[1] + n[2])
                            }
                    }

                    function q(A) {
                        for (var t = 2; t <= A.length; t++) K(A, t)
                    }

                    function $(A, t) {
                        this._context = A, this._ambisonicOrder = t;
                        var e, i, n, s, a, r = (t + 1) * (t + 1);
                        this._splitter = this._context.createChannelSplitter(r), this._merger = this._context.createChannelMerger(r), this._gainNodeMatrix = [];
                        for (var o = 1; o <= t; o++) {
                            e = o * o, i = 2 * o + 1, this._gainNodeMatrix[o - 1] = [];
                            for (var h = 0; h < i; h++) {
                                n = e + h;
                                for (var c = 0; c < i; c++) s = e + c, a = h * i + c, this._gainNodeMatrix[o - 1][a] = this._context.createGain(), this._splitter.connect(this._gainNodeMatrix[o - 1][a], n), this._gainNodeMatrix[o - 1][a].connect(this._merger, 0, s)
                            }
                        }
                    ...
                    G.prototype._buildAudioGraph = function() {
                        this.input = this._context.createGain(), this.output = this._context.createGain(), this._bypass = this._context.createGain(), this._foaRouter = new N(this._context, this._config.channelMap), this._foaRotator = new b(this._context), this._foaConvolver = new y(this._context), this.input.connect(this._foaRouter.input), this.input.connect(this._bypass), this._foaRouter.output.connect(this._foaRotator.input), this._foaRotator.output.connect(this._foaConvolver.input), this._foaConvolver.output.connect(this.output), this.input.channelCount = 4, this.input.channelCountMode = "explicit", this.input.channelInterpretation = "discrete"
                    }, G.prototype._initializeCallback = function(A, t) {
                        (this._config.pathList ? new x(this._context, this._config.pathList, {
                            dataType: "url"
                        }) : new x(this._context, S)).load().then(function(t) {
                            this._foaConvolver.setHRIRBufferList(t), this.setRenderingMode(this._config.renderingMode), this._isRendererReady = !0, T.log("FOARenderer: HRIRs loaded successfully. Ready."), A()
                        }.bind(this), (function() {
                            var A = "FOARenderer: HRIR loading/decoding failed.";
                            t(A), T.throw(A)
                        }))
                    }, G.prototype.initialize = function() {
                        return T.log("FOARenderer: Initializing... (mode: " + this._config.renderingMode + ")"), new Promise(this._initializeCallback.bind(this))
                    }, G.prototype.setChannelMap = function(A) {
                        this._isRendererReady && A.toString() !== this._config.channelMap.toString() && (T.log("Remapping channels ([" + this._config.channelMap.toString() + "] -> [" + A.toString() + "])."), this._config.channelMap = A.slice(), this._foaRouter.setChannelMap(this._config.channelMap))
                    }, G.prototype.setRotationMatrix3 = function(A) {
                        this._isRendererReady && this._foaRotator.setRotationMatrix3(A)
                    }, G.prototype.setRotationMatrix4 = function(A) {
                        this._isRendererReady && this._foaRotator.setRotationMatrix4(A)
                    }, G.prototype.setRotationMatrixFromCamera = function(A) {
                        this._isRendererReady && (T.invertMatrix4(this._tempMatrix4, A.elements), this._foaRotator.setRotationMatrix4(this._tempMatrix4))
                    }, G.prototype.setRenderingMode = function(A) {
                        if (A !== this._config.renderingMode) {
                            switch (A) {
                                ...
                                case H.OFF:
                                    ...
                                    break;
                                default:
                                    return void T.log('FOARenderer: Rendering mode "' + A + '" is not supported.')
                            }
                            this._config.renderingMode = A, T.log("FOARenderer: Rendering mode changed. (" + A + ")")
                        }
                    }, z.prototype._buildAudioGraph = function() {
                        ...
                        for (var t = 0; t < A; ++t) this._stereoMergers[t] = this._context.createChannelMerger(2), this._convolvers[t] = this._context.createConvolver(), this._stereoSplitters[t] = this._context.createChannelSplitter(2), this._convolvers[t].normalize = !1;
                        for (var e = 0; e <= this._ambisonicOrder; ++e)
                            for (var i = -e; i <= e; i++) {
                                var n = e * e + e + i,
                                    s = Math.floor(n / 2);
                                this._inputSplitter.connect(this._stereoMergers[s], n, n % 2), this._stereoMergers[s].connect(this._convolvers[s]), this._convolvers[s].connect(this._stereoSplitters[s]), i >= 0 ? this._stereoSplitters[s].connect(this._positiveIndexSphericalHarmonics, n % 2) : this._stereoSplitters[s].connect(this._negativeIndexSphericalHarmonics, n % 2)
                            }
                    ...
                    }, z.prototype.setHRIRBufferList = function(A) {
                        if (!this._isBufferLoaded) {
                            for (var t = 0; t < A.length; ++t) this._convolvers[t].buffer = A[t];
                    ...
                    function nA(A, t) {
                        this._context = T.isAudioContext(A) ? A : T.throw("HOARenderer: Invalid BaseAudioContext."), this._config = {
                            ambisonicOrder: 3,
                            renderingMode: eA.AMBISONIC
                        }, t && t.ambisonicOrder && (iA.includes(t.ambisonicOrder) ? this._config.ambisonicOrder = t.ambisonicOrder : T.log("HOARenderer: Invalid ambisonic order. (got " + t.ambisonicOrder + ") Fallbacks to 3rd-order ambisonic.")), this._config.numberOfChannels = (this._config.ambisonicOrder + 1) * (this._config.ambisonicOrder + 1), this._config.numberOfStereoChannels = Math.ceil(this._config.numberOfChannels / 2), t && t.hrirPathList && (Array.isArray(t.hrirPathList) && t.hrirPathList.length === this._config.numberOfStereoChannels ? this._config.pathList = t.hrirPathList : T.throw("HOARenderer: Invalid HRIR URLs. It must be an array with " + this._config.numberOfStereoChannels + " URLs to HRIR files. (got " + t.hrirPathList + ")")), t && t.renderingMode && (Object.values(eA).includes(t.renderingMode) ? this._config.renderingMode = t.renderingMode : T.log("HOARenderer: Invalid rendering mode. (got " + t.renderingMode + ') Fallbacks to "ambisonic".')), this._buildAudioGraph(), this._isRendererReady = !1
                    }
                    nA.prototype._buildAudioGraph = function() {
                        ...
                        (this._config.pathList ? new x(this._context, this._config.pathList, {
                            dataType: "url"
                        }) : 2 === this._config.ambisonicOrder ? new x(this._context, tA) : new x(this._context, AA)).load().then(function(t) {
                            this._hoaConvolver.setHRIRBufferList(t), this.setRenderingMode(this._config.renderingMode), this._isRendererReady = !0, T.log("HOARenderer: HRIRs loaded successfully. Ready."), A()
                        }.bind(this), (function() {
                            var A = "HOARenderer: HRIR loading/decoding failed.";
                            t(A), T.throw(A)
                        }))
                    }, nA.prototype.initialize = function() {
                        return T.log("HOARenderer: Initializing... (mode: " + this._config.renderingMode + ", ambisonic order: " + this._config.ambisonicOrder + ")"), new Promise(this._initializeCallback.bind(this))
                        ...
                        if (A !== this._config.renderingMode) {
                            switch (A) {
                                ...
                                case eA.OFF:
                                    ...
                                    break;
                                default:
                                    return void T.log('HOARenderer: Rendering mode "' + A + '" is not supported.')
                            }
                            this._config.renderingMode = A, T.log("HOARenderer: Rendering mode changed. (" + A + ")")
                        }
                    };
                    var sA = {
                            getBrowserInfo: function() {
                                ...
                                if (/trident/i.test(e[1])) return {
                                    name: "IE",
                                    version: (A = /\brv[ :]+(\d+)/g.exec(t) || [])[1] || ""
                                };
                                if ("Chrome" === e[1] && null != (A = t.match(/\bOPR|Edge\/(\d+)/))) return {
                                    name: "Opera",
                                    version: A[1]
                                };
                                e = e[2] ? [e[1], e[2]] : [navigator.appName, navigator.appVersion, "-?"], null != (A = t.match(/version\/([\d.]+)/i)) && e.splice(1, 1, A[1]);
                                var i = t.match(/android|ipad|iphone/i);
                                return i || (i = t.match(/cros|linux|mac os x|windows/i)), {
                                    name: e[0],
                                    version: e[1],
                        ...
                        aA = {};
                    aA.browserInfo = sA.getBrowserInfo(), aA.createBufferList = function(A, t, e) {
                        return new x(A, t, e || {
                            dataType: "url"
                        }).load()
                    }, aA.mergeBufferListByChannel = T.mergeBufferListByChannel, aA.splitBufferbyChannel = T.splitBufferbyChannel, aA.createFOAConvolver = function(A, t) {
                        return new y(A, t)
                    }, aA.createFOARouter = function(A, t) {
                        return new N(A, t)
                    }, aA.createFOARotator = function(A) {
                        return new b(A)
                    }, aA.createHOARotator = function(A, t) {
                        return new $(A, t)
                    }, aA.createHOAConvolver = function(A, t, e) {
                        return new z(A, t, e)
                    }, aA.createFOARenderer = function(A, t) {
                        return new G(A, t)
                    }, aA.createHOARenderer = function(A, t) {
                        return new nA(A, t)
                    }, T.log("Version 1.3.0 (running " + aA.browserInfo.name + " " + aA.browserInfo.version + " on " + aA.browserInfo.platform + ")"), "safari" === aA.browserInfo.name.toLowerCase() && (sA.patchSafari(), T.log(aA.browserInfo.name + " detected. Polyfill applied.")), t.a = aA
                }, function(A, t, e) {
                    "use strict";
                    t.a = "1.0.0"
                }])
...
//# sourceMappingURL=a59c5be8-c1bb0a4f7fbd14642d4f.js.map